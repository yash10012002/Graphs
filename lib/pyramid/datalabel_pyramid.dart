...
class DataLabelPyramid extends StatefulWidget {
  const DataLabelPyramid({super.key});

  @override
  State<DataLabelPyramid> createState() => _DataLabelPyramidState();
}

class _DataLabelPyramidState extends State<DataLabelPyramid> {
  ...
  SfPyramidChart _buildPyramidSmartLabelChart() {
    return SfPyramidChart(
      ...
      title: ChartTitle(text: 'Top 10 populated countries - 2019'),
