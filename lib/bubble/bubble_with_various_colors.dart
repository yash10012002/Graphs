...
class BubbleWithMultipleColors extends StatefulWidget {
  const BubbleWithMultipleColors({super.key});

  @override
  State<BubbleWithMultipleColors> createState() =>
      _BubbleWithMultipleColorsState();
}

class _BubbleWithMultipleColorsState extends State<BubbleWithMultipleColors> {
  ...
  SfCartesianChart _buildPointColorBubbleChart() {
    return SfCartesianChart(
      title: ChartTitle(text: 'Countries by area'),
