...
class BubbleWithMultipleSeries extends StatefulWidget {
  const BubbleWithMultipleSeries({super.key});

  @override
  State<BubbleWithMultipleSeries> createState() =>
      _BubbleWithMultipleSeriesState();
}

class _BubbleWithMultipleSeriesState extends State<BubbleWithMultipleSeries> {
  ...
  List<BubbleSeries<ChartSampleData, num>> _getMultipleBubbleSeries() {
    return <BubbleSeries<ChartSampleData, num>>[
      BubbleSeries<ChartSampleData, num>(
          ...
          dataLabelMapper: (ChartSampleData sales, _) => sales.x,
