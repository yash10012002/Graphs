...
class BubbleWithGradient extends StatefulWidget {
  const BubbleWithGradient({super.key});

  @override
  State<BubbleWithGradient> createState() => _BubbleWithGradientState();
}

class _BubbleWithGradientState extends State<BubbleWithGradient> {
  ...
  SfCartesianChart _buildGradientBubbleChart() {
    return SfCartesianChart(
      ...
      title: ChartTitle(text: 'Circket World cup statistics - till 2015'),
      ...
      primaryYAxis: NumericAxis(
          ...
          title: AxisTitle(text: 'Finals count'),
          minimum: 0,
          maximum: 4,
          interval: 1),
