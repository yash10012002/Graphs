...
class LineZone extends StatefulWidget {
  const LineZone({super.key});

  @override
  State<LineZone> createState() => _LineZoneState();
}

class _LineZoneState extends State<LineZone> {
  ...
  SfCartesianChart _buildLineZoneChart(BuildContext context) {
    ...
    return SfCartesianChart(
      ...
      title: ChartTitle(text: 'Average annual rainfall of United Kingdom'),
