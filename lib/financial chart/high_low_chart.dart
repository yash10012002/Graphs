...
class HighLowChart extends StatefulWidget {
  const HighLowChart({super.key});

  @override
  State<HighLowChart> createState() => _HighLowChartState();
}

class _HighLowChartState extends State<HighLowChart> {
