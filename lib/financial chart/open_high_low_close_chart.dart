...
class OpenHighLowCloseChart extends StatefulWidget {
  const OpenHighLowCloseChart({super.key});

  @override
  State<OpenHighLowCloseChart> createState() => _OpenHighLowCloseChartState();
}

class _OpenHighLowCloseChartState extends State<OpenHighLowCloseChart> {
