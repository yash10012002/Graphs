...
class AddRemoveSeries extends StatefulWidget {
  const AddRemoveSeries({super.key});

  @override
  State<AddRemoveSeries> createState() => _AddRemoveSeriesState();
}

class _AddRemoveSeriesState extends State<AddRemoveSeries> {
