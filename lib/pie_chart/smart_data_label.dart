...
class SmartDataLabel extends StatefulWidget {
  const SmartDataLabel({super.key});

  @override
  State<SmartDataLabel> createState() => _SmartDataLabelState();
}

class _SmartDataLabelState extends State<SmartDataLabel> {
  ...
  SfCircularChart _buildSmartLabelPieChart() {
    return SfCircularChart(
      title: ChartTitle(text: 'Gold medals count in Rio Olympics'),
