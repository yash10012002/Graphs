...
class ModifiedAxisBase extends StatefulWidget {
  const ModifiedAxisBase({super.key});

  @override
  State<ModifiedAxisBase> createState() => _ModifiedAxisBaseState();
}

class _ModifiedAxisBaseState extends State<ModifiedAxisBase> {
  List<String>? _axis;
