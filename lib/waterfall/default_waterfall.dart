...
class DefaultWaterfall extends StatefulWidget {
  const DefaultWaterfall({super.key});

  @override
  State<DefaultWaterfall> createState() => _DefaultWaterfallState();
}

class _DefaultWaterfallState extends State<DefaultWaterfall> {
  ...
  SfCartesianChart _buildDefaultWaterfallChart() {
    return SfCartesianChart(
      ...
      title: ChartTitle(text: 'Company revenue and profit'),
