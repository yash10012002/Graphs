...
class VerticalWaterfall extends StatefulWidget {
  const VerticalWaterfall({super.key});

  @override
  State<VerticalWaterfall> createState() => _VerticalWaterfallState();
}

class _VerticalWaterfallState extends State<VerticalWaterfall> {
        ...
        Expanded(
            ...
            child: SfCartesianChart(
              ...
              primaryXAxis: CategoryAxis(
                axisLine:
                    AxisLine(color: const Color.fromRGBO(101, 101, 101, 1)),
