...
class VerticalAreaChart extends StatefulWidget {
  const VerticalAreaChart({super.key});

  @override
  State<VerticalAreaChart> createState() => _VerticalAreaChartState();
}

class _VerticalAreaChartState extends State<VerticalAreaChart> {
  ...
  SfCartesianChart _buildVerticalAreaChart() {
    return SfCartesianChart(
      ...
      isTransposed: true,
      title: ChartTitle(text: 'Trend in sales of ethical produce'),
      primaryXAxis: const DateTimeAxis(
        majorGridLines: MajorGridLines(width: 0),
      ),
      primaryYAxis: NumericAxis(
          title: AxisTitle(text: 'Spends'),
