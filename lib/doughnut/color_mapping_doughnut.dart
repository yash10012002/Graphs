...
class ColorMappingDoughnut extends StatefulWidget {
  const ColorMappingDoughnut({super.key});

  @override
  State<ColorMappingDoughnut> createState() => _ColorMappingDoughnutState();
}

class _ColorMappingDoughnutState extends State<ColorMappingDoughnut> {
  @override
