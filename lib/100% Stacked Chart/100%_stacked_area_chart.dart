...
class FullStackedAreaChart extends StatefulWidget {
  const FullStackedAreaChart({super.key});

  @override
  State<FullStackedAreaChart> createState() => _FullStackedAreaChartState();
}

class _FullStackedAreaChartState extends State<FullStackedAreaChart> {
